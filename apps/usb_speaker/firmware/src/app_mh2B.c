...
DRV_I2S_DATA16   __attribute__((aligned(16))) __attribute__((tcm))
...
static const DRV_I2S_DATA16 
    __attribute__((aligned(16))) __attribute__((tcm)) audioSamples[48] =  {
...
static DRV_I2S_DATA16 
    __attribute__((aligned(16))) __attribute__((tcm)) 
...
static __attribute__((aligned(16))) __attribute__((tcm))
...
APP_DATA appData =
{
    ...
    .USBReadBufSize = 192,  //APP_MAX_NO_BYTES_IN_USB_BUFFER,   //48000Hz  1ms = 48*4 bytes
...
//                         appPlaybackBuffer.usbReadQueueCnt);
        ...
        {    
            ...
            else if  (usbReadCompleteFlag == true) //Playback
            {
                for (i = 0;
