...
void PIO_Initialize ( void )
{
   ...
   ((pio_registers_t*)PIO_PORT_A)->PIO_ABCDSR[0]= 0x00040000;
   ((pio_registers_t*)PIO_PORT_A)->PIO_ABCDSR[1]= 0x00000400;
   /* PORTA PIO Disable and Peripheral Enable*/
   ((pio_registers_t*)PIO_PORT_A)->PIO_PDR = ~0xFFFBFBE7;
   ...
   ((pio_registers_t*)PIO_PORT_B)->PIO_ABCDSR[0]= 0x00000003;
   ((pio_registers_t*)PIO_PORT_B)->PIO_ABCDSR[1]= 0x00000003;
   /* PORTB PIO Disable and Peripheral Enable*/
   ((pio_registers_t*)PIO_PORT_B)->PIO_PDR = ~0xFFFFFFFC;
   ...
   ((pio_registers_t*)PIO_PORT_D)->PIO_ABCDSR[0]= 0x04000000;
   ((pio_registers_t*)PIO_PORT_D)->PIO_ABCDSR[1]= 0x00000000;
   /* PORTD PIO Disable and Peripheral Enable*/
   ((pio_registers_t*)PIO_PORT_D)->PIO_PDR = ~0xFBFFFFFF;
