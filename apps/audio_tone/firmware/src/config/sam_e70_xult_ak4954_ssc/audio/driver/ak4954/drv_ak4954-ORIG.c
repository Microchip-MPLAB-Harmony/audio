/*******************************************************************************
  AK4954 Codec Driver Dynamic implemention.

  Company:
    Microchip Technology Inc.

  File Name:
    drv_AK4954_local_usb_audio.h
...
)
{
    ...
    drvObj->mclk_multiplier = 0;//!!DRV_AK4954_MCLK_SAMPLE_FREQ_MULTPLIER;
...
//!!    DRV_I2S_BaudSet(drvObj->i2sDriverHandle,
//!!                        (samplingRate*(DRV_AK4954_BCLK_BIT_CLK_DIVISOR)),
//!!                        samplingRate);
...
static void _DRV_AK4954_ControlTasks(DRV_AK4954_OBJ *drvObj)
{
    ...
    switch (drvObj->command)
    {
        ...
        case DRV_AK4954_COMMAND_INIT_CLK_PDN_SET:
        {
            ...
            /* Bring power down out of reset (Set PBSP_CODEC_AK4954_POWER_DOWN_PIN_CLRDN High) */
            STBYRST_Set();


            /* Initiate AK4954 Command */
            drvObj->command = DRV_AK4954_COMMAND_INIT_MODE_CTRL_SET;//DRV_AK4954_COMMAND_INIT_START;
