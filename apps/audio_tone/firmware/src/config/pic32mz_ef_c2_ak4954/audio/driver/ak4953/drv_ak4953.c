...
)
{
    ...
    drvObj->mclk_multiplier = 0;//!!DRV_AK4953_MCLK_SAMPLE_FREQ_MULTPLIER;
...
int8_t lastCommand = -1;

static void _DRV_AK4953_ControlTasks(DRV_AK4953_OBJ *drvObj)
{
    volatile uint8_t regValue;
    
    if (drvObj->command != lastCommand)
    {            
        printf ("CODEC STATE = %d\r\n",drvObj->command);
        lastCommand = drvObj->command;
    }
        ...
        case DRV_AK4953_COMMAND_INIT_MODE_CTRL_SET:
        {
            ...
            if  (drvObj->writeComplete && (false == drvObj->controlCommandStatus))
            {
                ...
                regValue = _DRV_AK4953_CONTROL_REG_FIELD_WRITE_Wrapper(drvObj,
                            ...
                            0xFF,
                            0,
                            0x03//MODECTRL1_DIF1_UP | MODECTRL1_DIF0_UP
                            );                 
...
//                            SIGSLCT1_PMMP_UP  //Mic enabled, Mic gain set
                ...
                regValue = _DRV_AK4953_CONTROL_REG_FIELD_WRITE_Wrapper(drvObj,
                            ...
                            0xFF,
                            0,
                            0x10//MODECTRL3_READ_UP | MODECTRL3_DVOLC_UP | MODECTRL3_OVOLC_UP
                            );
