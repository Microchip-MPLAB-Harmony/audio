...
#define MICROPHONE_EP 0x82  //IN_ENDPOINT
...
typedef enum
{
    ...
    APP_STATE_INIT                                     = 0,
    APP_STATE_CODEC_OPEN                               = 1,
    APP_STATE_CODEC_SET_BUFFER_HANDLER                 = 2,
    APP_STATE_USB_DEVICE_OPEN                          = 3,
    APP_STATE_WAIT_FOR_CONFIGURATION                   = 4,
    APP_STATE_INITIAL_USB_READ_REQUESTS                = 5,
    APP_STATE_INITIAL_CODEC_WRITEREAD_REQUESTS         = 6,
    APP_STATE_PROCESS_DATA                             = 7,
    APP_STATE_SAMPLING_FREQUENCY_CHANGE_HP             = 8,
    APP_STATE_SAMPLING_FREQUENCY_CHANGE_MP             = 9,
    APP_STATE_USB_INTERFACE_ALTERNATE_SETTING_RCVD     = 10,
    APP_STATE_USB_INTERFACE_ALTERNATE_SETTING_RCVD_HP  = 11,
    APP_STATE_USB_INTERFACE_ALTERNATE_SETTING_RCVD_MP  = 12,
    APP_STATE_MUTE_AUDIO_PLAYBACK                      = 13,
    APP_STATE_IDLE                                     = 14,
    APP_STATE_ERROR                                    = 15,
} APP_STATES;
...
typedef struct
{
    ...
    bool          volatile muteEn;     //Mute button control
    bool          volatile muteStatus; //Codec Audio Mute status 
