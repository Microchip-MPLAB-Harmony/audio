...
#define USB_DEVICE_AUDIO_CONTROL_INTERFACE_ID USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_CONTROL_INTERFACE_ID //0x00
#define APP_ID_INPUT_TERMINAL             USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_INPUT_TERMINAL_ID  //0x01
#define APP_ID_FEATURE_UNIT               USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_FEATURE_UNIT_ID    //0x02
#define APP_ID_OUTPUT_TERMINAL            USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_OUTPUT_TERMINAL_ID //0x03
#define APP_ID_INPUT_TERMINAL_MICROPHONE  USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_INPUT_TERMINAL_MICROPHONE_ID //0x04    
#define APP_ID_FEATURE_UNIT_MICROPHONE    USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_FEATURE_UNIT_MICROPHONE_ID   //0x05
#define APP_ID_OUTPUT_TERMINAL_MICROPHONE USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_OUTPUT_TERMINAL_MICROPHONE_ID //0x06    
#define APP_ID_FEATURE_UNIT_SIDE_TONING   USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_FEATURE_UNIT_SIDE_TONING_ID   //0x07    
#define APP_ID_MIXER_UNIT                 USB_DEVICE_AUDIO_IDX0_DESCRIPTOR_MIXER_UNIT_ID                 //0x08    
#define USB_DEVICE_AUDIO_STREAMING_INTERFACE_ID_1   0x01  //NOT USED
#else //0
//USB Descriptor definitions
...
//#define APP_MAX_RECORD_BUFFER_BYTES        APP_MAX_PLAYBACK_BUFFER_BYTES/2
...
#else //PIC32 MZ EF
    uint8_t __attribute__((coherent)) __attribute__((aligned(32))) 
        playbackbuffer[APP_MAX_PLAYBACK_BUFFER_BYTES]; //
    uint8_t __attribute__((coherent)) __attribute__((aligned(32))) 
        recordbuffer[APP_MAX_PLAYBACK_BUFFER_BYTES]; //
    uint8_t __attribute__((coherent)) __attribute__((aligned(32)))     
        aecbuffer[APP_MAX_RECORD_BUFFER_BYTES]; //
#endif
...
typedef struct {
#ifdef __CORE_CM7_H_GENERIC
    APP_RW_BUFFER __attribute__((aligned(32))) 
            buffer[APP_QUEUE_SIZE];
#else //PIC32 MZ EF
    APP_RW_BUFFER __attribute__((coherent)) __attribute__((aligned(32)))     
            buffer[APP_QUEUE_SIZE];
#endif
