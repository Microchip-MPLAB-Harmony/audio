...
loop:
	...
	addu	$t0, $t0, $a2		# outdata[i] = indata[i] + c
	addu	$t1, $t1, $a2		# outdata[i+1] = indata[i+1] + c
	addu	$t2, $t2, $a2		# outdata[i+2] = indata[i+2] + c
	addu	$t3, $t3, $a2		# outdata[i+3] = indata[i+3] + c
